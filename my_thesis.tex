...
\addcontentsline{toc}{chapter}{List of algorithms} % adds an entry to the table of contents
\listofalgorithms
...
\include{main/ch2_theorical_foundations}
\include{main/ch3_implementation_methodology}
\include{main/ch4_results}
\include{main/ch5_conclusion}
